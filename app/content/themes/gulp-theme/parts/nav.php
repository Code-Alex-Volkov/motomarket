<div class="menu-content">
	<div class="item-box item-box-hover">
		...
		<div class="item-sub-menu">
			...
			<a href="/moto2" class="menu-item-sub <?php if( $slug1 == 'moto2' ){ echo 'nav-active'; } ?>">
			...
			<a href="/moto3" class="menu-item-sub <?php if( $slug1 == 'moto3' ){ echo 'nav-active'; } ?>">
			...
			<a href="/moto4" class="menu-item-sub <?php if( $slug1 == 'moto4' ){ echo 'nav-active'; } ?>">
			...
			<a href="/moto5" class="menu-item-sub <?php if( $slug1 == 'moto5' ){ echo 'nav-active'; } ?>">
	...
	<div class="item-box item-box-hover">
		...
		<div class="item-sub-menu">
			...
			<a href="/snaryazhenie-aksessuary" class="menu-item-sub menu-item-sub-two <?php if( $slug1 == 'snaryazhenie-aksessuary' ){ echo 'nav-active'; } ?>">
				<span class="title">Аксессуары</span>
			</a>
			<a href="/ochki" class="menu-item-sub menu-item-sub-two <?php if( $slug1 == 'ochki' ){ echo 'nav-active'; } ?>">
				<span class="title">Очки</span>
			</a>
			<a href="/zashhitnaya-amunicziya" class="menu-item-sub menu-item-sub-two <?php if( $slug1 == 'zashhitnaya-amunicziya' ){ echo 'nav-active'; } ?>">
				<span class="title">Защитная амуниция</span>
			</a>
			<a href="/dzhersi" class="menu-item-sub menu-item-sub-two <?php if( $slug1 == 'dzhersi' ){ echo 'nav-active'; } ?>">
				<span class="title">Джерси</span>
			</a>
			<a href="/motoboty" class="menu-item-sub menu-item-sub-two <?php if( $slug1 == 'motoboty' ){ echo 'nav-active'; } ?>">
				<span class="title">Мотоботы</span>
			</a>
			<a href="/perchatki" class="menu-item-sub menu-item-sub-two <?php if( $slug1 == 'perchatki' ){ echo 'nav-active'; } ?>">
	...
	<div class="item-box item-box-hover">
		...
		<div class="item-sub-menu">
			...
			<a href="/kosmetika" class="menu-item-sub menu-item-sub-two <?php if( $slug1 == 'kosmetika' ){ echo 'nav-active'; } ?>">
				<span class="title">Косметика</span>
			</a>
			<a href="/tormoznaya-sistema" class="menu-item-sub menu-item-sub-two <?php if( $slug1 == 'tormoznaya-sistema' ){ echo 'nav-active'; } ?>">
				<span class="title">Тормозная система</span>
			</a>
			<a href="/czepi" class="menu-item-sub menu-item-sub-two <?php if( $slug1 == 'czepi' ){ echo 'nav-active'; } ?>">
				<span class="title">Цепи</span>
			</a>
			<a href="/elementy-upravleniya" class="menu-item-sub menu-item-sub-two <?php if( $slug1 == 'elementy-upravleniya' ){ echo 'nav-active'; } ?>">
	...
	<div class="item-box item-box-hover">
		...
		<div class="item-sub-menu">
			...
			<a href="/smazki" class="menu-item-sub menu-item-sub-two <?php if( $slug1 == 'smazki' ){ echo 'nav-active'; } ?>">
				<span class="title">Смазки</span>
			</a>
			<a href="/uhod-za-czepyu" class="menu-item-sub menu-item-sub-two <?php if( $slug1 == 'uhod-za-czepyu' ){ echo 'nav-active'; } ?>">
