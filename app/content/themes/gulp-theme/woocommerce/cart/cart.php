			...
			<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
				<thead>
					<tr>
						...
						<th class="product-name"><?php esc_html_e( 'Описание', 'woocommerce' ); ?></th>
						<th class="product-stock"><?php esc_html_e( 'Наличие на складе', 'woocommerce' ); ?></th>
						...
						<th class="product-remove"><?php esc_html_e( 'Удалить', 'woocommerce' ); ?></th>
					</tr>
				</thead>
				<tbody>
							...
							<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
								...
								<td class="product-name" data-title="<?php esc_attr_e( 'Product', 'woocommerce' ); ?>">
									<?php
										...
										if($_product->get_attribute('color')) {
											echo '<div class="articul">Цвет: <span>' . $_product->get_attribute('color') . '</span></div>';
										}
										if($_product->get_attribute('size')) {
											echo '<div class="articul">Размер: <span>' . $_product->get_attribute('size') . '</span></div>';
										}
									?>
								</td>
					...
					<tr class="product-action">
							<td colspan="6" class="actions">

								<?php if ( wc_coupons_enabled() ) { ?>
									<div class="coupon">
										<label for="coupon_code"><?php esc_html_e( 'Используйте промокод и получите скидку', 'woocommerce' ); ?></label> 
										<div class="feedback">
											...
											<button type="submit" class="button" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_attr_e( 'OK', 'woocommerce' ); ?></button>
										</div>
